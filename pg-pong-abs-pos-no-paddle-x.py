...
# Input dimensionality: 2 object positions for each paddle: (top position, bottom position)
...
def get_object_positions(img, display_message=False):
    ...
    return [paddle_1_top, paddle_1_bot, 
            paddle_2_top, paddle_2_bot, 
...
while True:
    ...
    if done: # an episode finished
        ...
        if episode_number % 200 == 0:
            pickle.dump(model, open('models/absolute_no_paddle_x_save_h'+ str(H) +'_' + str(save_counter) + '.p', 'wb'))
            save_counter +=1
